...
namespace Drupal\skincare_custom\Hook;
...
use Drupal\skincare_custom\RenderCallbacks;
...
/**
 * Contains hook implementations for SkincareCustom.
 */
final class ThemeHooks {
  ...
  public function themeSettingsFormAlter(array &$form): void {
    ...
    $message = $this->t("See <code>@path</code> to learn how to customize SkincareCustom's fonts, colors, and components.", [
      '@path' => $this->themeList->getPath('skincare_custom') . '/CUSTOMIZING.md',
    ]);
  ...
  public function preprocessHtml(array &$variables): void {
    ...
    $variables['skincare_custom_path'] = $this->requestStack->getCurrentRequest()->getBasePath() . '/' . $this->themeList->getPath('skincare_custom');
  }
